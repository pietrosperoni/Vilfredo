...
if ($userid)
{
	...
	$sql = "SELECT  questions.question, questions.roundid, questions.phase, proposals.blurb, proposals.roundid, questions.id FROM proposals, questions WHERE proposals.id = " . $proposal . " and proposals.experimentid = questions.id";
	...
	while ($row = mysql_fetch_row($response))
	{
		...
		echo '<h2>"<a href="viewquestion.php?q=' . $questionid . '">' . $questiontext . '</a>"</h2>';
