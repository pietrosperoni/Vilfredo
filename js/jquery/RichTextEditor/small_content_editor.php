   ...
   <table class="jqrte_menu">
      <tr>
         ...
         <td id="content_rte_copyright" title="<?=getLabel("Copyright",$language);?>"></td>
          <?php if ($RTE_TextLimit) { ?>
	          <td id="content_rte_chars_limit" title="">Max:</td>
	          <td id="content_rte_chars_remaining" title="Number of characters you have left"><?= $RTE_TextLimit; ?></td>
          <?php } ?>
      </tr>
   </table>
   </td>
