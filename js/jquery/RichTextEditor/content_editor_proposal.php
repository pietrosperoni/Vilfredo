...
<tr>
   ...
   <table class="jqrte_menu">
      <tr>
         ...
         <?php if ($RTE_TextLimit_content) { ?>
         <td id="content_rte_chars_remaining" title="Number of characters you have left until an abstract is required"><?= $RTE_TextLimit_content; ?></td>
         <td id="content_rte_chars_msg" title=""></td>
          <?php } ?>
      </tr>
   </table>
   </td>
